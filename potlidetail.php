...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Potli Bags Detail</h1>
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5 pb-3">
            <?php
            products($srp = 5800, $img = "./potli/potli1.jpg", $name = "Banjara Potli 1", $url = "./viewpage.php");
            products($srp = 5800, $img = "./potli/potli2.jpg", $name = "Banjara Potli 2", $url = "./viewpage.php");
            products($srp = 5800, $img = "./potli/potli3.PNG", $name = "Banjara Potli 3", $url = "./viewpage.php");
