...
<body>
    ...
    <div class="container-fluid bg-secondary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3">Policy</h1>
    ...
    <div class="container-fluid pt-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">Shipping Policy</span></h2>
        </div>
        <div class="row justify-content-center">
            <div class="col-8 align-self-center">
                <p style="text-align: justify;">
                    Your order will be delivered within 7 days following the order confirmation. Additional business days may be required for delivery during peak selling periods.
                    <br>
                    ...
                    <br>
                    Kindly note that deliveries are only made on working days.
                </p>
            </div>
        </div>
